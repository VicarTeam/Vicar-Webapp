import type {ActivatableBook} from "@/components/editor/BookSelection.vue";
...
export function getBookName(bookId: number): string {
  switch (bookId) {
    case 1:
      return "Grundregelwerk"
    case 2:
      return "Anarchen"
    case 3:
      return "Chicago by Night"
    case 4:
      return "Kompendium"
    case 5:
      return "Cults of the Blood Gods"
    case 6:
      return "Let the Streets Run Red"
    case 7:
      return "Sonderregeln"
    case 3021:
      return "Homebrew-Content"
    case 666:
      return "Ältere Vampire"
    default:
